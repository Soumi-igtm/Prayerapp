...
class DailyPrayer1Screen extends GetWidget<DailyPrayer1Controller> {
  @override
                                                ...
                                                children: [
                                                  Padding(
                                                      ...
                                                      child: Container(
                                                          ...
                                                          width: getSize(10.49),
                                                          child: SvgPicture.asset(ImageConstant.imgVector73, fit: BoxFit.fill))),
                                                  Padding(
                                                      padding: EdgeInsets.only(right: getHorizontalSize(19.50)),
                                                      child: Container(
                                                          height: getVerticalSize(17.14),
                                                          width: getHorizontalSize(15.86),
                                                          child: SvgPicture.asset(ImageConstant.imgVector74, fit: BoxFit.fill)))
                                                ])),
                                        Padding(
                                            ...
                                            child: Row(
                                                ...
                                                children: [
                                                  Container(
                                                      ...
                                                      decoration: BoxDecoration(color: ColorConstant.red300)),
                                                  Padding(
                                                          ...
                                                          children: [
                                                            ...
                                                            Align(
                                                                ...
                                                                child: Padding(
                                                                    ...
                                                                    child: Text("msg_worship_the_lor".tr,
                                                                        overflow: TextOverflow.ellipsis,
                                                                        textAlign: TextAlign.left,
                                                            ...
                                                            Align(
                                                                ...
                                                                child: Padding(
                                                                    ...
                                                                    child: Text("msg_tap_the_circle".tr,
                                                                        overflow: TextOverflow.ellipsis,
                                                                        textAlign: TextAlign.left,
                                                                        style: AppStyle.textstylemontserratregular111
  ...
  onTapEllipse7() {
    Get.toNamed(AppRoutes.dailyPrayer2Screen);
  }
}
