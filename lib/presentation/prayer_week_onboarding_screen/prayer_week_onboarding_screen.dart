...
class PrayerWeekOnboardingScreen extends GetWidget<PrayerWeekOnboardingController> {
  @override
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Container(
                                            ...
                                            width: getSize(17.00),
                                            child: SvgPicture.asset(ImageConstant.imgEmojionewhite20, fit: BoxFit.fill)),
                                        Padding(
                                            padding: EdgeInsets.only(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Container(
                                            height: getSize(17.00),
                                            width: getSize(17.00),
                                            child: SvgPicture.asset(ImageConstant.imgEmojionewhite21, fit: BoxFit.fill)),
                                        Padding(
                                            padding: EdgeInsets.only(
                                                left: getHorizontalSize(10.00), top: getVerticalSize(1.00), bottom: getVerticalSize(1.00)),
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Container(
                                            height: getSize(17.00),
                                            width: getSize(17.00),
                                            child: SvgPicture.asset(ImageConstant.imgEmojionewhite22, fit: BoxFit.fill)),
                                        Container(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Container(
                                            height: getSize(17.00),
                                            width: getSize(17.00),
                                            child: SvgPicture.asset(ImageConstant.imgEmojionewhite23, fit: BoxFit.fill)),
                                        Padding(
                                            padding: EdgeInsets.only(
                                                left: getHorizontalSize(10.00), top: getVerticalSize(1.00), bottom: getVerticalSize(1.00)),
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Container(
                                            height: getSize(17.00),
                                            width: getSize(17.00),
                                            child: SvgPicture.asset(ImageConstant.imgEmojionewhite24, fit: BoxFit.fill)),
                                        Padding(
                                            padding: EdgeInsets.only(
                                                left: getHorizontalSize(10.00), top: getVerticalSize(1.00), bottom: getVerticalSize(1.00)),
