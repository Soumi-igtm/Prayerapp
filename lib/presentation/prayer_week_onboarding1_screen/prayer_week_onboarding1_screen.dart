...
class PrayerWeekOnboarding1Screen extends GetWidget<PrayerWeekOnboarding1Controller> {
  @override
                                        ...
                                        Align(
                                            ...
                                            child: Padding(
                                                padding: EdgeInsets.only(
                                                    left: getHorizontalSize(119.00), top: getVerticalSize(115.00), right: getHorizontalSize(119.00)),
                                                child: Text("lbl_week_2".tr,
                                                    overflow: TextOverflow.ellipsis,
                                                    textAlign: TextAlign.left,
                                                    style: AppStyle.textstylemontserratblack18.copyWith(fontSize: getFontSize(18))))),
                                        Container(
                                            margin: EdgeInsets.only(
                                                ...
                                                bottom: getVerticalSize(115.00)),
                                            child: RichText(
                                                text: TextSpan(children: [
                                                  TextSpan(
                                                      text: "lbl_study_romans".tr,
                                                      style: TextStyle(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Container(
                                            ...
                                            width: getSize(17.00),
                                            child: SvgPicture.asset(ImageConstant.imgEmojionewhite25, fit: BoxFit.fill)),
                                        Padding(
                                            padding: EdgeInsets.only(
                                                left: getHorizontalSize(10.00), top: getVerticalSize(1.00), bottom: getVerticalSize(1.00)),
                                            child: Text("msg_set_alarm_for_52".tr,
                                                overflow: TextOverflow.ellipsis,
                                                textAlign: TextAlign.left,
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Container(
                                            height: getSize(17.00),
                                            width: getSize(17.00),
                                            child: SvgPicture.asset(ImageConstant.imgEmojionewhite26, fit: BoxFit.fill)),
                                        Padding(
                                            padding: EdgeInsets.only(
                                                left: getHorizontalSize(10.00), top: getVerticalSize(1.00), bottom: getVerticalSize(1.00)),
                                            child: Text("msg_pray_in_the_spi3".tr,
                                                overflow: TextOverflow.ellipsis,
                                                textAlign: TextAlign.left,
                                                style: AppStyle.textstylemontserratregular12.copyWith(fontSize: getFontSize(12))))
                                      ]))),
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Container(
                                            height: getSize(17.00),
                                            width: getSize(17.00),
                                            child: SvgPicture.asset(ImageConstant.imgEmojionewhite27, fit: BoxFit.fill)),
                                        Container(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Container(
                                            height: getSize(17.00),
                                            width: getSize(17.00),
                                            child: SvgPicture.asset(ImageConstant.imgEmojionewhite28, fit: BoxFit.fill)),
                                        Padding(
                                            padding: EdgeInsets.only(
                                                left: getHorizontalSize(10.00), top: getVerticalSize(1.00), bottom: getVerticalSize(1.00)),
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Container(
                                            height: getSize(17.00),
                                            width: getSize(17.00),
                                            child: SvgPicture.asset(ImageConstant.imgEmojionewhite29, fit: BoxFit.fill)),
                                        Padding(
                                            padding: EdgeInsets.only(
                                                left: getHorizontalSize(10.00), top: getVerticalSize(1.00), bottom: getVerticalSize(1.00)),
